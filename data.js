...
export const siteData = {
    ...
    bentoServices: [
        { 
            ...
            order: "01 // MANAGEMENT", 
            icon: "psychology", 
            title: "Elite Talent Management", 
            desc: "We craft comprehensive professional architectures. From brand integrity calibration arrays to legal syndicate routing systems, we preserve your identity infrastructure.", 
            tags: ["Contracts Matrix", "PR Placement", "Asset Safety"] 
        },
        { 
            type: "accent", 
            icon: "videocam", 
            title: "Cinematic Studio", 
            desc: "In-house production engineering processing high-fidelity media layout properties.", 
        ...
        { 
            ...
            desc: "Connecting curated rosters with enterprise global houses for high-value storytelling ventures." 
        },
        { 
            type: "small-icon", 
            icon: "monitoring", 
            ...
            desc: "Financial deployment infrastructures mapping long-tail alternative assets and decentralized income routes." 
        }
    ],
    metrics: [
        { label: "Audience Reach", value: 20, suffix: "M+" },
        { label: "Enterprise Deals", value: 500, suffix: "+" },
        { label: "Elite Creators", value: 150, suffix: "+" },
        { label: "Retention Scale", value: 98, suffix: "%" }
    ],
    brands: ["SAMSUNG", "NETFLIX", "ADIDAS", "MERCEDES", "ROLEX", "CANON"],
    timeline: [
        { phase: "PHASE 01", title: "Discovery Strategy Matrix", desc: "Deep data analytics parsing current demographic positioning and untapped scale capacity vectors." },
